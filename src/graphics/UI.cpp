...
void UI::drawPanel(sf::RenderTarget& target, sf::FloatRect rect, sf::Color border) const
{
    ...
    outer.setFillColor(sf::Color(10, 11, 17, 242));
    ...
    inner.setFillColor(sf::Color(20, 20, 29, 155));
    inner.setOutlineColor(sf::Color(border.r, border.g, border.b, 75));
                    ...
                    const std::string& label, bool active, sf::Color accent) const
{
    ...
    text.setFillColor(active ? sf::Color(240, 225, 190)
                             : sf::Color(175, 168, 158));
    target.draw(text);
}
                    ...
                    float ratio, float width, sf::Color accent) const
{
    ...
    sf::RectangleShape bg({width, 11.f});
    bg.setPosition(pos);
    ...
    sf::RectangleShape fill({width * ratio, 11.f});
